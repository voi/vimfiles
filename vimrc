...
command! -nargs=? Mru browse filter /<args>/ oldfiles
...
augroup vimrc_auto_commands
  ...
  autocmd FileType qf nnoremap <buffer> <expr> <S-CR> printf(":pclose\<CR>\<CR>:%sclose\<CR>",
